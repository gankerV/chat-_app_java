...
public class UserMain extends javax.swing.JFrame {
    public UserMain() {
        ...
        slide.setAnimate(5);
        slide.init(login, register,recovery);
        login.addEventRegister((ActionEvent ae) -> {
            slide.show(1);
            register.register();
        });
        login.addEventForgot_password((ActionEvent ae) -> {
            slide.show(2);
            register.register();
        });
        ...
        recovery.addEventBackLogin((ActionEvent ae) -> {
            slide.show(0);
            login.login();
        });
    }
    ...
    private void initComponents() {
        ...
        panelGradiente1.setColorPrimario(new java.awt.Color(102, 102, 102));
        ...
        panelGradiente1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelGradiente1Layout.createSequentialGroup()
                ...
                .addComponent(panelBorder1, javax.swing.GroupLayout.PREFERRED_SIZE, 569, javax.swing.GroupLayout.PREFERRED_SIZE)
